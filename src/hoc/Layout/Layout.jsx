...
import {Paper, Typography, makeStyles, Grid, Hidden, withStyles, Button, Card, CardContent} from "@material-ui/core";
...
const Layout = (props) => {
    ...
    return (
        ...
        <Paper className={classes.mainBanner} >
           <Grid container justify="flex-start" alignItems="center" alignContent='flex-start'>
                    
                    
                    <Hidden xsDown>
                        <Grid item container    sm={7} md={5} lg={4} justify='flex-end'   className={classes.titleGrid} >
                            <Typography variant="h1" gutterBottom >ISU Corp</Typography> 
                        </Grid>
                    ...
                    <Hidden smUp>
                        <Grid container item xs={5} justify="center" className={classes.titleGrid}  >
                        <Typography variant="h6" gutterBottom >ISU Corp</Typography> 
                    ...
                    <Hidden xsDown> 
                            <Grid sm={5} md={7} lg={5} item container justify='flex-start'  className={classes.titleGrid}>
                                <Typography variant="h6" style={{
                                    textAlign:"left",
                                }}>World Class <br/> Software Development </Typography>
                            </Grid>
                    </Hidden>
               <Hidden smUp>                   
            ...
            <Paper className={classes.subHeader} elevation={0}>
                <Grid container justify='center' alignContent='center' alignItems='center' className={classes.contentSubHeader} >
                    ...
                    <Grid container item xs={12} sm={2} justify="center"   >
                        <Typography variant='h5' color='error' align='left'>{currentAction}</Typography>
                    ...
                    style={{
                        ...
                        <Typography paragraph color='textSecondary' align='left' >sashjdfoiwfghwa ef wefoijashf fwea fkwepfo  waefpwefj p wergfqerwgsd fwejfpwesf fwe jfwejf  fwejfp wjf fjwep fwfpwq  wqefjwp fjf wef jwqpf  </Typography>
